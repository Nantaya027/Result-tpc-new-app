...
Account
    ...
    sleep   5
    AppiumLibrary.Click Element     xpath=/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.widget.EditText[1]
    sleep   3
    AppiumLibrary.Clear Text        xpath=//android.widget.EditText[1]
    sleep   5
    AppiumLibrary.Input Text        xpath=//android.widget.EditText[1]     tonaorna
    sleep   5
